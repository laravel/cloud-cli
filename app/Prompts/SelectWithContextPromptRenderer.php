...
class SelectWithContextPromptRenderer extends Renderer implements Scrolling
{
    use DrawsScrollbars;
    use DrawsThemeBoxes;
     ...
     */
    public function __invoke(SelectWithContextPrompt $prompt): string
    {
     ...
     * Render the options.
     */
    protected function renderOptions(SelectWithContextPrompt $prompt): string
    {
